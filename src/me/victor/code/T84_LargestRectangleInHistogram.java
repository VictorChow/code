 ...
 */
class T84_LargestRectangleInHistogram {

    public static void main(String[] args) {
        var t = new T84_LargestRectangleInHistogram();
        //        System.out.println(t.largestRectangleArea(Util.arr(2, 1, 5, 6, 2, 3)));//10
        //        System.out.println(t.largestRectangleArea(Util.arr(2, 4)));//4
        //        System.out.println(t.largestRectangleArea(Util.arr(5)));//5
        System.out.println(t.largestRectangleArea(Util.arr(8, 3, 12, 4, 3)));//12
        System.out.println(t.largestRectangleArea2(Util.arr(8, 3, 11, 3)));//12
    }
    ...
    public int largestRectangleArea(int[] heights) {
        ...
        */
        ...
        // [1,2,3]->[0,1,2,3,0]
        System.arraycopy(heights, 0, newHeight, 1, len - 1 - 1);
    ...
    public int largestRectangleArea2(int[] heights) {
        ...
        for (int i = 0; i < len; i++) {
            while (!stack.isEmpty() && newHeight[i] < newHeight[stack.peek()]) {
                var pop = stack.pop();
                //var area = (i - stack.peek() - 1) * newHeight[pop];
                var h = newHeight[pop];
                var w = i - pop;
                var area = h * w;
